 ...
 */
struct CnnConfig {
    explicit CnnConfig(const std::string& path_to_model_,
                       const std::string& path_to_weights_)
        : path_to_model(path_to_model_), path_to_weights(path_to_weights_) {}
    explicit CnnConfig(){}

    void CnnConfig_Create(const std::string& path_to_model_,
                       const std::string& path_to_weights_){
                           path_to_model = path_to_model_;
                           path_to_weights = path_to_weights_;
                       }
...
class CnnBase {
public:
    using Config = CnnConfig;     // using = type define
                                  // path_to_model path_to_weight
    /**
     * @brief Constructor
     */
